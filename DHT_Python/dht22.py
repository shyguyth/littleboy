...
class DHT22Result:
    'DHT11 sensor result returned by DHT22.read() method'
...
class DHT22:
	...
	def read(self):
		...
		#return DHT22Result(DHT22Result.ERR_NO_ERROR, the_bytes[2], the_bytes[0])
		humidity = ((the_bytes[0] & 0x7F)* 256 + the_bytes[1]) * 0.1
		temperature = ((the_bytes[2] & 0x7F) * 256 + the_bytes[3]) * 0.1
		if (the_bytes[2] & 0x80) :
			temperature *= -1
